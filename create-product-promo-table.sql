...
CREATE POLICY "Allow public read access" ON product_promo_reports
  FOR SELECT USING (true);

CREATE POLICY "Allow public insert access" ON product_promo_reports
  FOR INSERT WITH CHECK (true);

CREATE POLICY "Allow public update access" ON product_promo_reports

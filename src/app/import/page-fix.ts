// page-fix.ts - 导入功能的独立测试文件
// 使用方式：复制 handleFileSelect 函数到 page.tsx 中使用
...
export const handleFileSelect = async (e: React.ChangeEvent<HTMLInputElement> | File) => {
  const selectedFile = e instanceof File ? e : (e as React.ChangeEvent<HTMLInputElement>).target.files?.[0]
